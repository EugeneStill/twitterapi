...
import estest.twitter.constants.Auth1;
import estest.twitter.constants.Path1;
//import estest.twitter.constants.Auth;
//import estest.twitter.constants.Path;
...
public class RestUtilities {
	...
	public static RequestSpecification getRequestSpecification() {
		AuthenticationScheme authScheme = 
				RestAssured.oauth(Auth1.CONSUMER_KEY, Auth1.CONSUMER_SECRET, Auth1.ACCESS_TOKEN,
						Auth1.ACCESS_SECRET);
		REQUEST_BUILDER = new RequestSpecBuilder();
		REQUEST_BUILDER.setBaseUri(Path1.BASE_URI);
	...
	public static ResponseSpecification getResponseSpecification() {
		...
		RESPONSE_BUILDER.expectResponseTime(lessThan(8L), TimeUnit.SECONDS);
